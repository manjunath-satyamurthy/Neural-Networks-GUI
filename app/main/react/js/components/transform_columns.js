...
class TransformColumnsComponent extends Component {
	...
	onArgumentsSelection(e){
  	...
  	render() {
  		...
  		if (this.state.isLoading){
  			...
  			className="container top-margin-4 btn btn-secondary" disabled>Transform</button>;
  		} else {
	  		executeBtn = <button type="button" onClick={this.execute} 
	  			className="container top-margin-4 btn btn-secondary">Transform</button>;
  		}
	  	...
	  	return ( 
		  	<div>
		  		...
		  		<div className="container">
		  			<h3 align="center">Transform Columns</h3>
		  		</div>
...
export { TransformColumnsComponent };